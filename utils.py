...
def run_test(
    ...
    print(f"Best solution length: {max_length}")
    print(f"Worst solution length: {min_length}")
    print(f"Average execution time: {avg_time:.4f} seconds")
    print(f"Best execution time: {max_time:.4f} seconds")
    print(f"Worst execution time: {min_time:.4f} seconds")
